...
Внутренняя система аналитики и автоматизации для оптовой компании в сфере ветеринарных и коневодческих товаров. Помогает планировать закупки, прогнозировать спрос и убирать ручную рутину при работе с ERP, маркетплейсами и доставкой. Развёрнута и работает в продакшене — используется каждый день отделом закупок и руководством.
