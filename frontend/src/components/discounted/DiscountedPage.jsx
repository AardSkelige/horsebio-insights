...
const FLOW = [
    ['Лера', 'Находит товар с подходящим сроком и проводит техоперацию в МойСклад — товар становится уценённой карточкой'],
            ...
            <Page>
                ...
                {data && (
                    <>
                        ...
                        {inStock.length === 0 && (
                            <EmptyState
                                title="Уценённого товара на складе сейчас нет"
                            ...
                            {stats && (
                                <section className="uc-block">
                                    ...
                                    <p className="uc-note">
                                        ...
                                        товар с истекающим сроком ушёл бы в списание. Продажи и списания
                                        считаем по документам МойСклад, перемещения между складами в итоги
                                        не идут.
                                    </p>
                                </section>
                            )}
