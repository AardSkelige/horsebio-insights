...
const FLOW = [
    ...
    ['Система', 'Здесь видно, что стоит на витрине: цена и остаток с сайта. Когда до конца срока остаётся два месяца — позицию пора снимать'],
];
                        ...
                        <div className="uc-footer">
                            ...
                            <section className="uc-block">
                                ...
                                <p className="uc-fallback">
                                    ...
                                    Файл заводит скрытыми только те карточки, которых ещё нет на витрине;
                                    те, что уже продаются, он не трогает.
                                </p>
                                <p className="uc-fallback">
