...
import {
    ...
    MapPin, Truck, PackageOpen, Coins,
} from 'lucide-react';
...
export const SCRIPT_META = {
    ...
    horsebio_returns_ozon_enrich: {
        ...
        hint: 'Статус отвечает, что делать: «Едет к нам» — ждём; «Забрать в ПВЗ» — лежит в пункте '
            + 'выдачи, надо съездить; «У нас — разобрать» — товар на складе; «Завис в пути» — больше '
            + 'месяца в дороге; «Ушёл на склад МП» — к нам не приедет, документ закроется сам через '
            + '30 дней. Списки документов смотреть не здесь, а в «Что разобрать из возвратов» — '
            + 'эта страница только про работу робота. Черновики без номера отправления (ФБО, '
            + 'заведённые вручную) он не трогает.',
    },
