...
export const PENDING_RETURNS_HINT =
    ...
    + 'проводят — и возврат отсюда исчезает. У возвратов Ozon робот знает, где коробка, и ставит статус: '
    + '«Уже у нас» значит доставили, надо разобрать и провести; «завис в пути» — товар дольше 60 дней в '
    + 'дороге (срок, когда ещё можно предъявить претензию перевозчику), пора смотреть в кабинете '
    + 'маркетплейса. У Wildberries маршрут из API не достать — судим по возрасту.';
