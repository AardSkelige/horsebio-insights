...
# Столько дней в пути — и возврат считается зависшим: срок, после которого
# перевозчику/маркетплейсу можно предъявить претензию за пропавшую посылку
# (то же значение, что у роботов маршрутов)
WARN_DAYS = 60
