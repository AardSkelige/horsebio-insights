...
STATE_DEFS = [
    # (имя,        цвет,     rgb,             тип,            смысл для склада)
    (IN_TRANSIT,  0x78909C, 'серо-синий',    'Regular',      'маркетплейс везёт к нам — ждать'),
    (AT_OUR_SITE, 0xFFB300, 'жёлтый',        'Regular',      'товар у нас — проверить и провести'),
    (STUCK,       0xE53935, 'красный',       'Regular',      'едет к нам, но застрял — писать в поддержку'),
    (GONE_TO_MP,  0x546E7A, 'тёмно-серый',   'Unsuccessful', 'остался у маркетплейса — к нам не придёт'),
]
