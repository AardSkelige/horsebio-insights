...
SCRIPTS_CONFIG = [
    ...
    },
    {
        ...
        'account': 'HorseBio',
        'schedule': 'Каждые 5 ч с 09:00',
        'description': 'Робот: черновики возвратов по спискам возвратов Озона и ВБ',
    ...
    },
    {
        ...
        'description': 'Статус черновиков возвратов Озон по данным Ozon API',
    ...
    },
    {
        ...
        'description': 'Статус черновиков возвратов ВБ по отчёту Wildberries',
