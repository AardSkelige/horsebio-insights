...
SCRIPTS_CONFIG = [
    ...
    },
    {
        ...
        'account': 'HorseBio',
        'schedule': 'Каждые 5 ч с 09:00',
        'description': 'Робот: черновики возвратов — ВБ по статусу заказа, Озон по Ozon API',
    ...
    },
    {
        ...
        'description': 'Ставит черновикам возвратов Озон статус по данным Ozon API: едет к нам / забрать в ПВЗ / у нас — разобрать / завис в пути / ушёл на склад МП; осевшие у Озона удаляет через 30 дней',
    ...
    },
    {
        ...
        'topic': 'Возвраты',
        'name': 'Возвраты ВБ — маршрут',
        'account': 'HorseBio',
        'schedule': 'Каждые 5 ч с 09:30',
        'description': 'Ставит черновикам возвратов ВБ статус по отчёту Wildberries: едет к нам / забрать в ПВЗ / у нас — разобрать / завис в пути',
