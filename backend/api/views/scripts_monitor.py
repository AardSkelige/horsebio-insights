...
SCRIPTS_CONFIG = [
    ...
    },
    {
        ...
        'description': 'Ставит черновикам возвратов Озон статус по данным Ozon API: едет к нам / у нас — разобрать / завис в пути / ушёл на склад МП; осевшие у Озона удаляет через 30 дней',
