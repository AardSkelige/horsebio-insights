...
urlpatterns = [
    ...
    path('delivery/products/', delivery.products, name='delivery_products'),
    path('delivery/orders/', delivery.recent_orders, name='delivery_recent_orders'),
    path('delivery/cities/', delivery.cities, name='delivery_cities'),
