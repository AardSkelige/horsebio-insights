...
case $STATUS in
  ...
  "$LOCK_BUSY")
    ...
    ;;
  65)
    # Синхронизация: часть сущностей обновилась, часть нет. Своя строка —
    # чтобы «не дались отгрузки» не читалось как «не вышло ничего».
    log "частично: часть сущностей не обновилась — $OUTPUT"
    ;;
  124)
